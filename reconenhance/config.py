...
config_dir = appdirs.user_config_dir('ReconEnhance')
...
config = {
	'protected_classes': ['reconenhance', 'target', 'service', 'commandstreamreader', 'plugin', 'portscan', 'servicescan', 'global', 'pattern'],
